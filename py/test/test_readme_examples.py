# Genderizeio SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GenderizeioSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GenderizeioSDK(...) and GenderizeioSDK.test(...) become
#      GenderizeioSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "genderizeio_sdk"
_SDK_CLASS = "GenderizeioSDK"
