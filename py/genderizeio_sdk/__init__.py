...
from genderizeio_sdk.utility import register

# Load features
from genderizeio_sdk.feature.base_feature import GenderizeioBaseFeature
from genderizeio_sdk.features import _has_feature, _make_feature
...
class GenderizeioSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = GenderizeioUtility()
        self._utility = utility

        from genderizeio_sdk.config import shared_config
    ...
    def get_utility(self):
        return GenderizeioUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GenderizeioSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetGender(self, data=None) -> "GetGenderEntity":
        ...
        from genderizeio_sdk.entity.get_gender_entity import GetGenderEntity
