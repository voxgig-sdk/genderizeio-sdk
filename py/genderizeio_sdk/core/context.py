...
from genderizeio_sdk.core.control import GenderizeioControl
...
from genderizeio_sdk.core.helpers import get_ctx_prop, to_map
...
class GenderizeioContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, GenderizeioSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, GenderizeioResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, GenderizeioResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return GenderizeioError(code, msg, self)
