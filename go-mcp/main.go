// Command Genderizeio-mcp is an MCP server exposing the Genderizeio
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Genderizeio_list  — list records of an entity
//	Genderizeio_load  — load a single record of an entity
//
