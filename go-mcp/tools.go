...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_gender"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.GenderizeioSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "genderizeio_list",
		Description: "List records from Genderizeio. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "genderizeio_load",
		Description: "Load a single record from Genderizeio. " +
...
func runOp(client *sdk.GenderizeioSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.GenderizeioSDK, name string) (sdk.GenderizeioEntity, error) {
	switch strings.ToLower(name) {
	case "get_gender":
		return client.GetGender(nil), nil
