...
func (sdk *GenderizeioSDK) OptionsMap() map[string]any {
...
func (sdk *GenderizeioSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *GenderizeioSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *GenderizeioSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GenderizeioSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *GenderizeioSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *GenderizeioSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("GenderizeioSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *GenderizeioSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GenderizeioSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("GenderizeioSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
