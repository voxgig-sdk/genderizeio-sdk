...
type GetGenderEntity struct {
	name    string
	client  *core.GenderizeioSDK
...
func NewGetGenderEntity(client *core.GenderizeioSDK, entopts map[string]any) *GetGenderEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetGenderEntity) GetName() string { return e.name }
...
func (e *GetGenderEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetGenderEntity) Deleted() bool {
	return e.deleted
}


func (e *GetGenderEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetGenderEntity(e.client, opts)
}

func (e *GetGenderEntity) Data(args ...any) any {
...
func (e *GetGenderEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetGender; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetGenderEntity) DataTyped(data ...GetGender) GetGender {
	if len(data) > 0 {
		return typedFrom[GetGender](e.Data(asMap(data[0])))
	}
	return typedFrom[GetGender](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetGender (all fields
// optional at the wire level).
func (e *GetGenderEntity) MatchTyped(match ...GetGender) GetGender {
	if len(match) > 0 {
		return typedFrom[GetGender](e.Match(asMap(match[0])))
	}
	return typedFrom[GetGender](e.Match())
}
...
func (e *GetGenderEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetGenderEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetGenderLoadMatch and returns an GetGender. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetGenderEntity) LoadTyped(reqmatch GetGenderLoadMatch, ctrl map[string]any) (GetGender, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetGender{}, err
	}
	return typedFrom[GetGender](res), nil
}



func (e *GetGenderEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetGenderEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetGenderEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetGenderEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetGenderEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
