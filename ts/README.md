# Genderizeio TypeScript SDK



The TypeScript SDK for the Genderizeio API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.GetGender()` — each with a small set of operations (`load`)
...
```ts
const client = new GenderizeioSDK({ apikey: '...' })
...
| `tester(testopts?, sdkopts?)` | `GenderizeioSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `GenderizeioSDK.test(testopts?, sdkopts?)` | `GenderizeioSDK` | Create a test-mode client. |
...
| `client` | `client(): GenderizeioSDK` | Return the parent SDK client. |
...
genderizeio/
├── src/
│   ├── GenderizeioSDK.ts        # Main SDK class
