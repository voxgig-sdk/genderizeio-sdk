...
function envOverride(m) {
    if ('TRUE' === process.env.GENDERIZEIO_TEST_LIVE ||
        'TRUE' === process.env.GENDERIZEIO_TEST_OVERRIDE) {
    ...
    m.GENDERIZEIO_TEST_EXPLAIN = process.env.GENDERIZEIO_TEST_EXPLAIN || m.GENDERIZEIO_TEST_EXPLAIN;
    return m;
}
