...
(0, node_test_1.describe)('GetGenderDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.GenderizeioSDK({
    ...
    (0, node_test_1.test)('direct-load-get_gender', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_gender', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.GENDERIZEIO_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.GenderizeioSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.GENDERIZEIO_APIKEY,
        }));
        let idmap = env['GENDERIZEIO_TEST_GET_GENDER_ENTID'];
    ...
    const client = new __1.GenderizeioSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetGenderDirect.test.js.map