...
describe('exists', async () => {
  ...
  //
  // GenderizeioSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof GenderizeioSDK, true,
      'GenderizeioSDK.test() must return a client synchronously')
  })
