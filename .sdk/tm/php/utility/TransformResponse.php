...
// Genderizeio SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class GenderizeioTransformResponse
{
    public static function call(GenderizeioContext $ctx): mixed
    {
        ...
        $transform = GenderizeioHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
