...
// Genderizeio SDK clienttrack feature
...
class GenderizeioClienttrackFeature extends GenderizeioBaseFeature
{
    ...
    public function PostConstruct(GenderizeioContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Genderizeio-SDK';
