...
// Genderizeio SDK streaming feature
...
class GenderizeioStreamingFeature extends GenderizeioBaseFeature
{
    ...
    private function _iterate(GenderizeioResult $result): \Generator
    {
    ...
    private function _streamable(GenderizeioContext $ctx): bool
    {
