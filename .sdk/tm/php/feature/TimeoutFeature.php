...
// Genderizeio SDK timeout feature
...
class GenderizeioTimeoutFeature extends GenderizeioBaseFeature
{
    ...
    private function _with_timeout(GenderizeioContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GenderizeioContext $_ctx, float $ms): void
    {
        $client = $this->client;
