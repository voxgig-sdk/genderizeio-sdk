...
|---|---|---|
| `ts/` | @voxgig-sdk/genderizeio-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/genderizeio-sdk \
      --repository voxgig-sdk/genderizeio-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/genderizeio-sdk` shows it, and
`npm trust revoke @voxgig-sdk/genderizeio-sdk --id=<id>` removes it.
