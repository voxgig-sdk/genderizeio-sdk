...
local GetGenderEntity = {}
GetGenderEntity.__index = GetGenderEntity


function GetGenderEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetGenderEntity)
  self._name = "get_gender"
  self._client = client
...
function GetGenderEntity:get_name()
  return self._name
end


function GetGenderEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetGenderEntity.new(self._client, opts)
end
...
function GetGenderEntity:mark_deleted()
  self._deleted = true
end


function GetGenderEntity:deleted()
  return true == self._deleted
end


function GetGenderEntity:data_set(args)
  if args ~= nil then
...
function GetGenderEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetGenderEntity:match_set(args)
  if args ~= nil then
...
function GetGenderEntity:match_get()
...
function GetGenderEntity:stream(action, args, callopts)
...
---@param reqmatch GetGenderLoadMatch
---@param ctrl? table
---@return GetGender
---@return string? err
function GetGenderEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetGenderEntity:_run_op(ctx, post_done)
  local utility = self._utility
