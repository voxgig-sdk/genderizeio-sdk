...
describe("GetGenderDirect", function()
  it("should direct-load-get_gender", function()
    local setup = get_gender_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_gender", setup.live and "live" or "unit")
...
function get_gender_direct_setup(mockres)
