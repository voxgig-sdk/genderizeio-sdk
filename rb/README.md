# Genderizeio Ruby SDK



The Ruby SDK for the Genderizeio API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `GenderizeioError` (a `StandardError` subclass), so wrap
...
```
rb/
├── Genderizeio_sdk.rb       -- Main SDK module
...
The main module (`Genderizeio_sdk`) exports the SDK class
