...
#      offline in seeded test mode (GenderizeioSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Genderizeio_sdk.rb")
  SDK_CLASS = "GenderizeioSDK"
