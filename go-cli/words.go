...
func registerSDKWords(r *eng.Registry, client *sdk.GenderizeioSDK) {
...
func runOp(client *sdk.GenderizeioSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
