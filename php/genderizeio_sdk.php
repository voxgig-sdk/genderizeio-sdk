...
class GenderizeioSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = GenderizeioHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = GenderizeioHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!GenderizeioFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, GenderizeioFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return GenderizeioUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = GenderizeioHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = GenderizeioHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = GenderizeioHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new GenderizeioError($op . "_allow",
                "GenderizeioSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = GenderizeioHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new GenderizeioError("graphql_error",
                "GenderizeioSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function GetGender($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_gender === null) {
                $this->_get_gender = new GetGenderEntity($this, null);
            }
            return $this->_get_gender;
        }
        return new GetGenderEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new GenderizeioSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
