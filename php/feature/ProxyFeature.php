...
class GenderizeioProxyFeature extends GenderizeioBaseFeature
{
    ...
    public function init(GenderizeioContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GenderizeioContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
