...
class GenderizeioCacheFeature extends GenderizeioBaseFeature
{
    ...
    private function _through(GenderizeioContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
