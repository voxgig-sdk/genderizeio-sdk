...
// Genderizeio SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GenderizeioTestFeature extends GenderizeioBaseFeature
{
    ...
    public function init(GenderizeioContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GenderizeioContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = GenderizeioParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GenderizeioContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GenderizeioContext $ctx, $op, $args): array
    {
