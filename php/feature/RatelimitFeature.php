...
// Genderizeio SDK ratelimit feature
...
class GenderizeioRatelimitFeature extends GenderizeioBaseFeature
{
    ...
    private function _acquire(GenderizeioContext $ctx): void
    {
    ...
    private function _track(GenderizeioContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
