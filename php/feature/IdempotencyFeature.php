...
// Genderizeio SDK idempotency feature
...
class GenderizeioIdempotencyFeature extends GenderizeioBaseFeature
{
    ...
    private function _mutating(GenderizeioContext $ctx): bool
    {
