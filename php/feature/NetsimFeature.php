...
// Genderizeio SDK netsim feature
...
class GenderizeioNetsimFeature extends GenderizeioBaseFeature
{
    ...
    private function _simulate(GenderizeioContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GenderizeioContext $ctx, array $applied): void
    {
        $client = $this->client;
