...
// Genderizeio SDK telemetry feature
...
class GenderizeioTelemetryFeature extends GenderizeioBaseFeature
{
    ...
    private function _close(GenderizeioContext $ctx, bool $ok): void
    {
