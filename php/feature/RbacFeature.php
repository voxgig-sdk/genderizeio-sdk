...
class GenderizeioRbacFeature extends GenderizeioBaseFeature
{
    ...
    private function _required(GenderizeioContext $ctx): ?string
    {
    ...
    private function _reject(GenderizeioContext $ctx, string $required): void
    {
    ...
    private function _track(GenderizeioContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
