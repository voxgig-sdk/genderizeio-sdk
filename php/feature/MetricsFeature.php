...
// Genderizeio SDK metrics feature
...
class GenderizeioMetricsFeature extends GenderizeioBaseFeature
{
    ...
    private function _record(GenderizeioContext $ctx, bool $ok): void
    {
