...
// Genderizeio SDK utility: graphql
//
...
class GenderizeioGraphql
{
    ...
    // equivalent.
    public static function body(GenderizeioContext $ctx): mixed
    {
    ...
    public static function errors(GenderizeioContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
