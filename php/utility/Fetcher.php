...
// Genderizeio SDK utility: fetcher

class GenderizeioFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GenderizeioSDK/1.0)';
    ...
    public static function call(GenderizeioContext $ctx, string $fullurl, array $fetchdef): array
    {
