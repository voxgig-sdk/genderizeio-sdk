...
// Genderizeio SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GenderizeioMakeRequest
{
    public static function call(GenderizeioContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GenderizeioResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GenderizeioResponse($fetched);
        } else {
