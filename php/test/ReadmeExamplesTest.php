...
// Genderizeio SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GenderizeioSDK::test)
...
{
    private const SDK_CLASS = 'GenderizeioSDK';
    ...
    private const SDK_BASE = 'genderizeio_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../genderizeio_sdk.php';
