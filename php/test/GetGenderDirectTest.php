...
class GetGenderDirectTest extends TestCase
{
    public function test_direct_load_get_gender(): void
    {
        $setup = get_gender_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-get_gender", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
