...
class GenderizeioTestRunner
{
    ...
    {
        $live = self::getenv('GENDERIZEIO_TEST_LIVE');
        $override = self::getenv('GENDERIZEIO_TEST_OVERRIDE');
        ...
        $explain = self::getenv('GENDERIZEIO_TEST_EXPLAIN');
...
class_alias('GenderizeioTestRunner', 'Runner');
class_alias('GenderizeioHelpers', 'Helpers');
